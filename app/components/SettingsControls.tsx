 ...
 *
 * Reusable control components extracted from the AppearanceCustomizer drawer.
 * Used by both the floating drawer and the full-page /dashboard/settings/appearance route.
 *
 * All components read/write directly to the Zustand settings store.
 * No custom Context, no state mirroring, no duplicate preference logic.
 */
...
export function OptionCard({ icon, label, selected, onClick }: OptionCardProps) {
  return (
    ...
    >
      <Icon icon={icon} width={20} height={20} style={{ flexShrink: 0 }} />
      <Typography
        variant="caption"
        sx={{
...
export function NavLayoutThumbnail({
  layout,
  selected,
  onClick,
  label,
    ...
    >
      <Box
        sx={{
          ...
          alignItems: "center",
          justifyContent: "center",
          backgroundColor: (t) => t.lighten(t.palette.primary.main, 0.6),
          flexShrink: 0,
          mt: 0.25,
        }}
      >
...
// =============================================================================
// Settings Controls Panel (reusable in drawer or page)
// =============================================================================
